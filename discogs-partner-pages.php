<?php
/*
Plugin Name:    Discogs Partner Pages
Plugin URI:     https://github.com/SeedyROM/discogs-partner-pages
...
include('blocks/partner-feed/index.php');
...
class PartnerPageTemplate
{
    ...
    public static function get_instance()
    {
        if (null == self::$instance) {
            self::$instance = new PartnerPageTemplate();
        }
